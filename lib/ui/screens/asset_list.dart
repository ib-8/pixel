...
Future<void> _selectDate(BuildContext context,TextEditingController controller,DateTime? selectedDate) async {
  ...
  type:typeController.text,
   ...
   var response= await DatabaseTable.assets.insert(asset.toMap()).select('id');
  var expense = Expenses(type: ownerShipController.text, assetId: response.first['id'].toString(), amount: expenseController.text, vendor: '', note: '', date: dateController.text,);
